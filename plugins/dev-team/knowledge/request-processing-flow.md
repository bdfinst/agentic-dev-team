...
| **Implement** | Test-Driven Development (opt-in cadence), Systematic Debugging, Mutation Testing, Browser Testing, Performance Benchmark, CI Debugging | Build in small per-behavior batches (code-first default, TDD opt-in), debug issues, validate quality, measure performance |
