...
| Test Design Reviewer | `skills/test-design-reviewer/SKILL.md` | 600 | QA Engineer, test-review, `/build` (final branch score), `/test-design` (all existing tests), `/test-health` |
