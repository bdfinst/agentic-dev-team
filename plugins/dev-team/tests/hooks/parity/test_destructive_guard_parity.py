"""Parity fixtures for hooks/destructive-guard (#598)."""
...
_HOOK_SH = _REPO_ROOT / "plugins" / "dev-team" / "hooks" / "destructive-guard.sh"
_HOOK_PY = _REPO_ROOT / "plugins" / "dev-team" / "hooks" / "destructive_guard.py"
_FIXTURES_DIR = Path(__file__).resolve().parent / "fixtures" / "destructive_guard"
