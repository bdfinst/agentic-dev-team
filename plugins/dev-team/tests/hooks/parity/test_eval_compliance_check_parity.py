"""Parity fixtures for hooks/eval-compliance-check (#599)."""
...
_HOOK_SH = _REPO_ROOT / "plugins" / "dev-team" / "hooks" / "eval-compliance-check.sh"
_HOOK_PY = _REPO_ROOT / "plugins" / "dev-team" / "hooks" / "eval_compliance_check.py"
_FIXTURES_DIR = Path(__file__).resolve().parent / "fixtures" / "eval_compliance_check"
