"""Parity fixtures for hooks/session-model-banner (#586)."""
...
_HOOK_SH = _REPO_ROOT / "plugins" / "dev-team" / "hooks" / "session-model-banner.sh"
_HOOK_PY = _REPO_ROOT / "plugins" / "dev-team" / "hooks" / "session_model_banner.py"
_FIXTURES_DIR = Path(__file__).resolve().parent / "fixtures" / "session_model_banner"
