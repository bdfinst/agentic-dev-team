...
3. Regenerate the skills catalog — `docs/skills.md` is generated from frontmatter: `bash plugins/dev-team/hooks/lib/build-skills-index.sh`
...
2. Regenerate the skills catalog — `docs/skills.md` is generated from frontmatter: `bash plugins/dev-team/hooks/lib/build-skills-index.sh`
...
| Skills (user-invocable) | `plugins/dev-team/CLAUDE.md` Skills Registry table | `README.md` (`plugins/dev-team/docs/skills.md` is generated by `build-skills-index.sh` — never hand-edited) |
