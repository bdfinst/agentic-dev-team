...
<#
.SYNOPSIS
    Install the tools the security-assessment plugin calls on Windows.
...
if ($Help) {
    Write-Host @"
install-windows.ps1 — install security-assessment tool dependencies on Windows.
...
Write-Host "    bash plugins/security-assessment/install.sh"
Write-Host ""
