...
The bundled CSS at `plugins/security-assessment/templates/report-css/default.css` is modelled on the `opus_repo_scan_test` reference's `utilities/convert_report.py` CSS:
