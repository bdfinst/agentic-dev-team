#!/usr/bin/env bash
# install.sh — Verify prerequisites for the marketplace-dev plugin.
#
...
echo "Checking marketplace-dev prerequisites..."
echo ""
...
echo "--- Optional ---"
check_optional "git" \
  "version-control operations in scaffolded marketplaces" \
