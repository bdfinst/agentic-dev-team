...
JOBS="$REPO_ROOT/plugins/dev-team/scripts/build_jobs.py"
WAVE="$REPO_ROOT/plugins/dev-team/scripts/build_wave.py"
RECONCILE="$REPO_ROOT/plugins/dev-team/scripts/build_wave_reconcile.py"
