...
3. **`plugins/dev-team/skills/plan/SKILL.md`** — two insertion points (the step-3 decision procedure's full text lives in `references/gherkin-persistence.md`, keeping the always-loaded SKILL.md under its 200-line extraction guard; SKILL.md carries a pointer):
