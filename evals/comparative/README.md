...
Full runbook: [`comparative-testing.md`](../../plugins/security-assessment/plugins/security-assessment/docs/comparative-testing.md).
...
- **Adversarial ML pipeline** (probes 01-08 + analyzer agents). Needs a mock
  target; see `plugins/security-assessment/docs/comparative-testing.md` § Future improvements.
...
- Add a component-level unit test: create a spec under `unit-tests/` and
  link it from `plugins/security-assessment/docs/comparative-testing.md` § Component-level equivalence
  map.
- Real-world comparison: see `plugins/security-assessment/docs/comparative-testing.md` § Approach 3
