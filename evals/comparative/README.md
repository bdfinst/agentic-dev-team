...
Full runbook: [`../../docs/comparative-testing.md`](../../docs/comparative-testing.md).
...
- **Adversarial ML pipeline** (probes 01-08 + analyzer agents). Needs a mock
  target; see `docs/comparative-testing.md` § Future improvements.
...
- Add a component-level unit test: create a spec under `unit-tests/` and
  link it from `docs/comparative-testing.md` § Component-level equivalence
  map.
- Real-world comparison: see `docs/comparative-testing.md` § Approach 3
