...
- [x] Slice 1: Atomic core — effort contract, resolver/ladder, dispatch data flow
  ...
  - [x] Step 1.4: Effort band → ladder position in the resolver
  - [x] Step 1.5: Hook looks up effort by subagent_type; legacy tier fallback
  - [x] Step 1.6: Gitignore the ladder; retire overrides

#### Wave 2

- [x] Slice 2: SessionStart banner — capture session model, replace overrides-banner.sh
...
- [x] Slice 6: Diagnostics + docs + spec reconcile
  - [x] Step 6.1: Update `/model-routing-check`
  - [x] Step 6.2: Reconcile docs + orchestrator + CLAUDE.md + spec
  - [x] Step 6.3: Author the model-routing override guide + README TOC entry
